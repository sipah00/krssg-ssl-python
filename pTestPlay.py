...
class pTestPlay(object):
    ...
    def tactic_instance(self, bot_id, tactic_id, params, other_bot_id=-1):
        ...
        elif tactic_id = "TGoToFix":
            instance = tactic_factory.TGoToFix.TGoToFix(bot_id, self.state, params)
        elif tactic_id = "TPosition":
    ...
    def bs_callback(self, data):
        ...
        tac_1 = self.tactic_instance( test_bot_id, self.role_list[0][0], self.role_list[0][1])     #attacker or *testit
